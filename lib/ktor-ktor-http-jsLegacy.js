(function(root, factory) {
  ...
  var encodeBase64 = $module$ktor_ktor_utils_jsLegacy.io.ktor.util.encodeBase64_pdl1vz$;
  var decodeBase64String = $module$ktor_ktor_utils_jsLegacy.io.ktor.util.decodeBase64String_pdl1vz$;
  ...
  var Month$values = $module$ktor_ktor_utils_jsLegacy.io.ktor.util.date.Month.values;
  var ensureNotNull = Kotlin.ensureNotNull;
  var IntRange = Kotlin.kotlin.ranges.IntRange;
  var GMTDate = $module$ktor_ktor_utils_jsLegacy.io.ktor.util.date.GMTDate_qlqxlw$;
  var IllegalStateException_init = Kotlin.kotlin.IllegalStateException_init_pdl1vj$;
  var IllegalStateException = Kotlin.kotlin.IllegalStateException;
  var GMTDateParser = $module$ktor_ktor_utils_jsLegacy.io.ktor.util.date.GMTDateParser;
  var InvalidDateStringException = $module$ktor_ktor_utils_jsLegacy.io.ktor.util.date.InvalidDateStringException;
  ...
  var StringValuesSingleImpl = $module$ktor_ktor_utils_jsLegacy.io.ktor.util.StringValuesSingleImpl;
  ...
  var contains_0 = $module$ktor_ktor_utils_jsLegacy.io.ktor.util.contains_9p7nab$;
  ...
  var sha1 = $module$ktor_ktor_utils_jsLegacy.io.ktor.util.sha1_fqrh44$;
  var encodeBase64_0 = $module$ktor_ktor_utils_jsLegacy.io.ktor.util.encodeBase64_964n91$;
  ...
  StringLexer.prototype.capture_ephubc$ = defineInlineFunction('ktor-ktor-http-jsLegacy.io.ktor.http.StringLexer.capture_ephubc$', function(block) {
  ...
  var otherwise = defineInlineFunction('ktor-ktor-http-jsLegacy.io.ktor.http.otherwise_xf59e$', function($receiver, block) {
  if (!$receiver) 
    block();
});
  var tryParseTime = defineInlineFunction('ktor-ktor-http-jsLegacy.io.ktor.http.tryParseTime_ndhspt$', wrapFunction(function() {
  ...
  var tryParseMonth = defineInlineFunction('ktor-ktor-http-jsLegacy.io.ktor.http.tryParseMonth_gw2jwt$', wrapFunction(function() {
  var Month$values = _.$$importsForInline$$['ktor-ktor-utils-jsLegacy'].io.ktor.util.date.Month.values;
  var startsWith = Kotlin.kotlin.text.startsWith_7epoxm$;
  return function($receiver, success) {
  var tmp$, tmp$_0;
  ...
  var tryParseDayOfMonth = defineInlineFunction('ktor-ktor-http-jsLegacy.io.ktor.http.tryParseDayOfMonth_j48bfd$', wrapFunction(function() {
  var StringLexer_init = _.io.ktor.http.StringLexer;
  var unboxChar = Kotlin.unboxChar;
  var isDigit = _.io.ktor.http.isDigit_nupfqh$;
  var toInt = Kotlin.kotlin.text.toInt_pdl1vz$;
  ...
  var tryParseYear = defineInlineFunction('ktor-ktor-http-jsLegacy.io.ktor.http.tryParseYear_j48bfd$', wrapFunction(function() {
  var StringLexer_init = _.io.ktor.http.StringLexer;
  var unboxChar = Kotlin.unboxChar;
  var isDigit = _.io.ktor.http.isDigit_nupfqh$;
  var toInt = Kotlin.kotlin.text.toInt_pdl1vz$;
  ...
  var get_ExceptionFailed = defineInlineFunction('ktor-ktor-http-jsLegacy.io.ktor.http.get_ExceptionFailed_i80ybi$', function($receiver) {
  ...
  function get_authority($receiver) {
    ...
    if ($receiver.user != null) {
      $receiver_0.append_pdl1vj$(encodeURLParameter($receiver.user));
      if ($receiver.password != null) {
        $receiver_0.append_s8itvh$(58);
        $receiver_0.append_pdl1vj$(encodeURLParameter($receiver.password));
      }
  ...
  function get_authority_0($receiver) {
    ...
    if ((tmp$ = $receiver.user) != null) {
      var tmp$_0;
      $receiver_0.append_pdl1vj$(encodeURLParameter(tmp$));
      if ((tmp$_0 = $receiver.password) != null) {
        $receiver_0.append_pdl1vj$(':');
        $receiver_0.append_pdl1vj$(encodeURLParameter(tmp$_0));
      }
      $receiver_0.append_pdl1vj$('@');
    }
    $receiver_0.append_pdl1vj$($receiver.host);
  ...
  var flatten = defineInlineFunction('ktor-ktor-http-jsLegacy.io.ktor.http.parsing.flatten_mtaoqd$', wrapFunction(function() {
  var Unit = Kotlin.kotlin.Unit;
  var wrapFunction = Kotlin.wrapFunction;
  ...
  $$importsForInline$$['ktor-ktor-http-jsLegacy'] = _;
  ...
  Kotlin.defineModule('ktor-ktor-http-jsLegacy', _);
  return _;
}));
