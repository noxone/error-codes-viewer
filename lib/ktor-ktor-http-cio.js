(function(root, factory) {
  if (typeof define === 'function' && define.amd) 
    define(['exports', 'kotlin', 'ktor-ktor-http', 'ktor-ktor-io', 'kotlinx-coroutines-core'], factory);
  else if (typeof exports === 'object') 
    factory(module.exports, require('kotlin'), require('ktor-ktor-http'), require('ktor-ktor-io'), require('kotlinx-coroutines-core'));
  else {
    ...
    root['ktor-ktor-http-cio'] = factory(typeof this['ktor-ktor-http-cio'] === 'undefined' ? {} : this['ktor-ktor-http-cio'], kotlin, this['ktor-ktor-http'], this['ktor-ktor-io'], this['kotlinx-coroutines-core']);
  }
}(this, function(_, Kotlin, $module$ktor_ktor_http, $module$ktor_ktor_io, $module$kotlinx_coroutines_core) {
  'use strict';
  ...
  var DefaultPool = $module$ktor_ktor_io.io.ktor.utils.io.pool.DefaultPool;
  var L_1 = Kotlin.Long.NEG_ONE;
  var COROUTINE_SUSPENDED = Kotlin.kotlin.coroutines.intrinsics.COROUTINE_SUSPENDED;
  var CoroutineImpl = Kotlin.kotlin.coroutines.CoroutineImpl;
  var writer = $module$ktor_ktor_io.io.ktor.utils.io.writer_x9a1ni$;
  var L0 = Kotlin.Long.ZERO;
  var EOFException = $module$ktor_ktor_io.io.ktor.utils.io.errors.EOFException;
  var equals = Kotlin.equals;
  var cancel = $module$ktor_ktor_io.io.ktor.utils.io.cancel_3dmw3p$;
  var copyTo = $module$ktor_ktor_io.io.ktor.utils.io.copyTo_47ygvz$;
  var Throwable = Error;
  var close = $module$ktor_ktor_io.io.ktor.utils.io.close_x5qia6$;
  var coroutines = $module$kotlinx_coroutines_core.kotlinx.coroutines;
  var reader = $module$ktor_ktor_io.io.ktor.utils.io.reader_ps9zta$;
  var IoBuffer = $module$ktor_ktor_io.io.ktor.utils.io.core.IoBuffer;
  var writeFully = $module$ktor_ktor_io.io.ktor.utils.io.writeFully_4scpqu$;
  var Buffer = $module$ktor_ktor_io.io.ktor.utils.io.core.Buffer;
  var throwCCE = Kotlin.throwCCE;
  var writeShort = $module$ktor_ktor_io.io.ktor.utils.io.core.writeShort_cx5lgg$;
  ...
  var writeShort_0 = $module$ktor_ktor_io.io.ktor.utils.io.core.writeShort_9kfkzl$;
  ...
  function Coroutine$decodeChunked$lambda(closure$input_0, closure$contentLength_0, $receiver_0, controller, continuation_0) {
  ...
  do try {
    switch (this.state_0) {
      case 0:
        this.state_0 = 2;
        this.result_0 = decodeChunked_2(this.local$closure$input, this.local$$receiver.channel, this.local$closure$contentLength, this);
  ...
  function decodeChunked$lambda(closure$input_0, closure$contentLength_0) {
    return function($receiver_0, continuation_0, suspended) {
  var instance = new Coroutine$decodeChunked$lambda(closure$input_0, closure$contentLength_0, $receiver_0, this, continuation_0);
  if (suspended) 
    return instance;
  else 
  ...
  function decodeChunked_0($receiver, input, contentLength) {
    return writer($receiver, $receiver.coroutineContext, void 0, decodeChunked$lambda(input, contentLength));
  }
  ...
  do try {
    switch (this.state_0) {
      ...
      case 2:
        ...
        if (!equals(this.local$contentLength, L_1) && this.local$chunkSize.compareTo_11rb$(this.local$contentLength.subtract(this.local$totalBytesCopied)) > 0) {
          cancel(this.local$input);
          throw new ParserException('Invalid chunk: chunk-encoded content is larger than expected ' + this.local$contentLength.toString());
        }
      ...
      case 6:
        ...
        continue;
      case 7:
        if (!equals(this.local$contentLength, L_1) && !equals(this.local$totalBytesCopied, this.local$contentLength)) {
          cancel(this.local$input);
          throw new EOFException('Corrupted chunk-encoded content: steam ended before the expected number of bytes (' + this.local$contentLength.toString() + ') were decoded.');
        }
        this.exceptionState_0 = 11;
  ...
  do try {
    switch (this.state_0) {
      ...
      case 5:
        ...
        var size = this.local$content.writePosition - this.local$content.readPosition | 0;
        tempBuffer.resetForWrite();
        writeIntHex(tempBuffer, size);
        var value = CrLfShort;
        var tmp$;
        writeShort(Kotlin.isType(tmp$ = tempBuffer, Buffer) ? tmp$ : throwCCE(), value);
        this.state_0 = 6;
        this.result_0 = this.local$$receiver_0.writeFully_99qa0s$(tempBuffer, this);
        if (this.result_0 === COROUTINE_SUSPENDED) 
          return COROUTINE_SUSPENDED;
        continue;
      case 6:
        this.state_0 = 7;
        this.result_0 = this.local$$receiver_0.writeFully_99qa0s$(this.local$content, this);
        if (this.result_0 === COROUTINE_SUSPENDED) 
          return COROUTINE_SUSPENDED;
        continue;
      case 7:
      ...
      case 9:
        if ((this.local$tmp$_0 = this.local$$receiver.request_za3lpa$()) != null) {
          ...
          var size_0 = this.local$tmp$_0.writePosition - this.local$tmp$_0.readPosition | 0;
          tempBuffer_0.resetForWrite();
          writeIntHex(tempBuffer_0, size_0);
          var value_0 = CrLfShort;
          var tmp$_0;
          writeShort(Kotlin.isType(tmp$_0 = tempBuffer_0, Buffer) ? tmp$_0 : throwCCE(), value_0);
          this.state_0 = 10;
          this.result_0 = this.local$closure$output_0.writeFully_99qa0s$(tempBuffer_0, this);
          if (this.result_0 === COROUTINE_SUSPENDED) 
            return COROUTINE_SUSPENDED;
          continue;
        } else {
      ...
      case 10:
        this.state_0 = 11;
        this.result_0 = this.local$closure$output_0.writeFully_99qa0s$(this.local$tmp$_0, this);
        if (this.result_0 === COROUTINE_SUSPENDED) 
          return COROUTINE_SUSPENDED;
        continue;
      case 11:
  ...
  do try {
    switch (this.state_0) {
      case 0:
        ...
        this.state_0 = 1;
        this.result_0 = this.local$input.readSuspendableSession_kiqllg$(encodeChunked$lambda_0(this.local$output, this.local$view), this);
        if (this.result_0 === COROUTINE_SUSPENDED) 
          return COROUTINE_SUSPENDED;
        continue;
      case 1:
      ...
      case 4:
        ...
        this.local$view.release_duua06$(IoBuffer.Companion.Pool);
        this.state_0 = this.finallyPath_0.shift();
        continue;
      case 5:
        return;
  ...
  do try {
    switch (this.state_0) {
      case 0:
        var size = this.local$chunk.writePosition - this.local$chunk.readPosition | 0;
        this.local$tempBuffer.resetForWrite();
        writeIntHex(this.local$tempBuffer, size);
        var value = CrLfShort;
        var tmp$;
        writeShort(Kotlin.isType(tmp$ = this.local$tempBuffer, Buffer) ? tmp$ : throwCCE(), value);
        this.state_0 = 2;
        this.result_0 = this.local$$receiver.writeFully_99qa0s$(this.local$tempBuffer, this);
        if (this.result_0 === COROUTINE_SUSPENDED) 
          return COROUTINE_SUSPENDED;
        continue;
      case 1:
      ...
      case 2:
        this.state_0 = 3;
        this.result_0 = this.local$$receiver.writeFully_99qa0s$(this.local$chunk, this);
        if (this.result_0 === COROUTINE_SUSPENDED) 
          return COROUTINE_SUSPENDED;
        continue;
      case 3:
      ...
      case 0:
        if (this.local$transferEncoding != null) {
          if (equalsLowerCase(this.local$transferEncoding, void 0, void 0, 'chunked')) {
            this.state_0 = 2;
            this.result_0 = decodeChunked_2(this.local$input, this.local$out, this.local$contentLength, this);
            if (this.result_0 === COROUTINE_SUSPENDED) 
              return COROUTINE_SUSPENDED;
            continue;
          } else {
  ...
  function Frame$Frame$Close_init(reason, $this) {
    ...
    var builder = BytePacketBuilder(0);
    try {
      writeShort_0(builder, reason.code);
  ...
  package$internals.writeIntHex_g087h2$ = writeIntHex;
  ...
  Frame.Binary_init_cqnnqj$ = Frame$Frame$Binary_init;
  Frame.Binary = Frame$Binary;
  Frame.Text_init_61zpoe$ = Frame$Frame$Text_init;
  Frame.Text_init_cqnnqj$ = Frame$Frame$Text_init_0;
