(function(root, factory) {
  if (typeof define === 'function' && define.amd) 
    define(['exports', 'kotlin', 'ktor-ktor-io', 'ktor-ktor-utils', 'kotlinx-coroutines-core'], factory);
  else if (typeof exports === 'object') 
    factory(module.exports, require('kotlin'), require('ktor-ktor-io'), require('ktor-ktor-utils'), require('kotlinx-coroutines-core'));
  else {
    ...
    root['ktor-ktor-http'] = factory(typeof this['ktor-ktor-http'] === 'undefined' ? {} : this['ktor-ktor-http'], kotlin, this['ktor-ktor-io'], this['ktor-ktor-utils'], this['kotlinx-coroutines-core']);
  }
}(this, function(_, Kotlin, $module$ktor_ktor_io, $module$ktor_ktor_utils, $module$kotlinx_coroutines_core) {
  'use strict';
  ...
  var encode = $module$ktor_ktor_io.io.ktor.utils.io.charsets.encode_fj4osb$;
  ...
  var prepareReadFirstHead = $module$ktor_ktor_io.io.ktor.utils.io.core.internal.prepareReadFirstHead_j319xh$;
  var prepareReadNextHead = $module$ktor_ktor_io.io.ktor.utils.io.core.internal.prepareReadNextHead_x2nit9$;
  var completeReadHead = $module$ktor_ktor_io.io.ktor.utils.io.core.internal.completeReadHead_x2nit9$;
  ...
  var Charset = $module$ktor_ktor_io.io.ktor.utils.io.charsets.Charset;
  ...
  var Month$values = $module$ktor_ktor_utils.io.ktor.util.date.Month.values;
  var ensureNotNull = Kotlin.ensureNotNull;
  var IntRange = Kotlin.kotlin.ranges.IntRange;
  var GMTDate = $module$ktor_ktor_utils.io.ktor.util.date.GMTDate_qlqxlw$;
  var IllegalStateException_init = Kotlin.kotlin.IllegalStateException_init_pdl1vj$;
  var IllegalStateException = Kotlin.kotlin.IllegalStateException;
  var GMTDateParser = $module$ktor_ktor_utils.io.ktor.util.date.GMTDateParser;
  var InvalidDateStringException = $module$ktor_ktor_utils.io.ktor.util.date.InvalidDateStringException;
  ...
  function decodeImpl($receiver, start, end, prefixEnd, plusIsSpace, charset) {
    ...
    while (index < end) {
      ...
      if (plusIsSpace && c === 43) {
        ...
        sb.append_61zpoe$(String_0(bytes, 0, count, charset));
      } else {
        sb.append_s8itvh$(c);
        index = index + 1 | 0;
      }
  ...
  StringLexer.prototype.capture_ephubc$ = defineInlineFunction('ktor-ktor-http.io.ktor.http.StringLexer.capture_ephubc$', function(block) {
  ...
  var otherwise = defineInlineFunction('ktor-ktor-http.io.ktor.http.otherwise_xf59e$', function($receiver, block) {
  if (!$receiver) 
    block();
});
  var tryParseTime = defineInlineFunction('ktor-ktor-http.io.ktor.http.tryParseTime_ndhspt$', wrapFunction(function() {
  ...
  var tryParseMonth = defineInlineFunction('ktor-ktor-http.io.ktor.http.tryParseMonth_gw2jwt$', wrapFunction(function() {
  var Month$values = _.$$importsForInline$$['ktor-ktor-utils'].io.ktor.util.date.Month.values;
  var startsWith = Kotlin.kotlin.text.startsWith_7epoxm$;
  return function($receiver, success) {
  var tmp$, tmp$_0;
  ...
  var tryParseDayOfMonth = defineInlineFunction('ktor-ktor-http.io.ktor.http.tryParseDayOfMonth_j48bfd$', wrapFunction(function() {
  var StringLexer_init = _.io.ktor.http.StringLexer;
  var unboxChar = Kotlin.unboxChar;
  var isDigit = _.io.ktor.http.isDigit_nupfqh$;
  var toInt = Kotlin.kotlin.text.toInt_pdl1vz$;
  ...
  var tryParseYear = defineInlineFunction('ktor-ktor-http.io.ktor.http.tryParseYear_j48bfd$', wrapFunction(function() {
  var StringLexer_init = _.io.ktor.http.StringLexer;
  var unboxChar = Kotlin.unboxChar;
  var isDigit = _.io.ktor.http.isDigit_nupfqh$;
  var toInt = Kotlin.kotlin.text.toInt_pdl1vz$;
  ...
  function toHttpDate($receiver) {
    var $receiver_0 = StringBuilder_init_0();
    $receiver_0.append_61zpoe$($receiver.dayOfWeek.value + ', ');
    $receiver_0.append_61zpoe$(padZero($receiver.dayOfMonth, 2) + ' ');
    $receiver_0.append_61zpoe$($receiver.month.value + ' ');
    $receiver_0.append_61zpoe$(padZero($receiver.year, 4));
    $receiver_0.append_61zpoe$(' ' + padZero($receiver.hours, 2) + ':' + padZero($receiver.minutes, 2) + ':' + padZero($receiver.seconds, 2) + ' ');
    $receiver_0.append_61zpoe$('GMT');
    return $receiver_0.toString();
  }
  ...
  if (this.parameters.isEmpty()) 
    ...
    var tmp$_1;
    $receiver.append_61zpoe$(this.content);
    ...
    for (var index = 0; index < tmp$_1; index++) {
      ...
      $receiver.append_61zpoe$('; ');
      $receiver.append_61zpoe$(name);
      $receiver.append_61zpoe$('=');
      if (checkNeedEscape(value)) 
        $receiver.append_61zpoe$(quote(value));
      else 
        $receiver.append_61zpoe$(value);
    }
    return $receiver.toString();
  }
};
  ...
  function escapeIfNeededTo($receiver, out) {
    if (checkNeedEscape($receiver)) 
      out.append_61zpoe$(quote($receiver));
    else 
      out.append_61zpoe$($receiver);
  }
  ...
  var $receiver = StringBuilder_init_0();
  $receiver.append_61zpoe$(this.protocol.name);
  $receiver.append_61zpoe$('://');
  $receiver.append_61zpoe$(get_authority(this));
  $receiver.append_61zpoe$(get_fullPath(this));
  if (this.fragment.length > 0) {
    $receiver.append_s8itvh$(35);
    $receiver.append_61zpoe$(this.fragment);
  }
  return $receiver.toString();
};
  ...
  function get_authority($receiver) {
    ...
    if ($receiver.user != null) {
      $receiver_0.append_61zpoe$(encodeURLParameter($receiver.user));
      if ($receiver.password != null) {
        $receiver_0.append_s8itvh$(58);
        $receiver_0.append_61zpoe$(encodeURLParameter($receiver.password));
      }
      $receiver_0.append_s8itvh$(64);
    }
    if ($receiver.specifiedPort === 0) {
      $receiver_0.append_61zpoe$($receiver.host);
    } else {
      $receiver_0.append_61zpoe$(get_hostWithPort($receiver));
    }
    return $receiver_0.toString();
  }
  function get_authority_0($receiver) {
    var $receiver_0 = StringBuilder_init_0();
    var tmp$;
    if ((tmp$ = $receiver.user) != null) {
      var tmp$_0;
      $receiver_0.append_61zpoe$(encodeURLParameter(tmp$));
      if ((tmp$_0 = $receiver.password) != null) {
        $receiver_0.append_61zpoe$(':');
        $receiver_0.append_61zpoe$(encodeURLParameter(tmp$_0));
      }
      $receiver_0.append_61zpoe$('@');
    }
    $receiver_0.append_61zpoe$($receiver.host);
    if ($receiver.port !== 0 && $receiver.port !== $receiver.protocol.defaultPort) {
      $receiver_0.append_61zpoe$(':');
      $receiver_0.append_61zpoe$($receiver.port.toString());
    }
    return $receiver_0.toString();
  }
  ...
  function parseAuthorizationHeader(headerValue) {
    ...
    while (tmp$_1.hasNext()) {
      var element = tmp$_1.next();
      destination.put_xwzc9p$(ensureNotNull(element.groups.get_za3lpa$(1)).value, unescapedIfQuoted(ensureNotNull(element.groups.get_za3lpa$(2)).value));
    }
    var parameters = destination;
  ...
  function substringAfterMatch($receiver, result) {
    return drop($receiver, result.range.last + (result.range.isEmpty() ? 0 : 1) | 0);
  }
  function unescapedIfQuoted($receiver) {
  ...
  function TextContent(text, contentType, status) {
    ...
    this.bytes_m243v6$_0 = lazy_0(LazyThreadSafetyMode.NONE, TextContent$bytes$lambda(this));
  }
  ...
  v: shouldGroup ? offset + 1 | 0 : offset};
      ...
      while (tmp$_0.hasNext()) {
        ...
        if (index_0 !== 0 && Kotlin.isType($receiver, OrGrammar)) 
          expression.append_61zpoe$('|');
        expression.append_61zpoe$(current.regex);
