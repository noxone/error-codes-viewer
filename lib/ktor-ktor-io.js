(function(root, factory) {
  ...
  do try {
    switch (this.state_0) {
      case 0:
        ...
        var tmp$ = equals(remaining, L0);
        if (!tmp$) {
          tmp$ = (this.$this.readable.endOfInput && this.$this.closed);
        }
        if (tmp$) {
          this.$this.afterRead();
  ...
  if (Kotlin.isType(t_1, Throwable)) {
    ...
    throw t_1;
      ...
      sb.append_61zpoe$(decoder.decode());
    }    catch (t_2) {
