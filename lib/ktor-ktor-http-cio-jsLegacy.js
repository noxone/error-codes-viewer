(function(root, factory) {
  ...
  var ByteChannelSequentialBase = $module$ktor_ktor_io_jsLegacy.io.ktor.utils.io.ByteChannelSequentialBase;
  ...
  function rethrowCloseCause($receiver) {
    ...
    else if (Kotlin.isType($receiver, ByteChannelSequentialBase)) 
      tmp$ = $receiver.closedCause;
    else 
      tmp$ = null;
    var cause = tmp$;
