(function(root, factory) {
  ...
  var cancel = $module$ktor_ktor_io_jsLegacy.io.ktor.utils.io.cancel_3dmw3p$;
  ...
  var reader = $module$ktor_ktor_io_jsLegacy.io.ktor.utils.io.reader_ps9zta$;
  ...
  do try {
    switch (this.state_0) {
      case 0:
        ...
        this.state_0 = 2;
        this.result_0 = writeIntHex_0(this.local$$receiver, this.local$size, this);
        if (this.result_0 === COROUTINE_SUSPENDED) 
          return COROUTINE_SUSPENDED;
        continue;
      case 1:
  ...
  function writeIntHex_0($receiver_0, value_0, continuation_0, suspended) {
  ...
  var xor = defineInlineFunction('ktor-ktor-http-cio-jsLegacy.io.ktor.http.cio.websocket.xor_34yeqm$', wrapFunction(function() {
  var toByte = Kotlin.toByte;
  return function($receiver, other) {
  return toByte($receiver ^ other);
};
}));
  var flagAt = defineInlineFunction('ktor-ktor-http-cio-jsLegacy.io.ktor.http.cio.websocket.flagAt_wndlt3$', function($receiver, at) {
  ...
  $$importsForInline$$['ktor-ktor-http-cio-jsLegacy'] = _;
  ...
  package$internals.writeIntHex_95n5gx$ = writeIntHex_0;
  ...
  CR_0 = 13;
  LF_0 = 10;
  Kotlin.defineModule('ktor-ktor-http-cio-jsLegacy', _);
  return _;
}));
