(function(root, factory) {
    ...
    switch (this.state_0) {
      ...
      case 2:
        if ((tmp$ = this.local$info.type) != null ? tmp$.equals(getKClass(DefaultClientWebSocketSession)) : null) {
          ...
          var clientSession = new DefaultClientWebSocketSession(this.local$$receiver.context, $receiver.asDefault_om4bzv$(this.local$session));
          this.state_0 = 3;
  ...
  WebSockets.prototype.asDefault_om4bzv$ = function($receiver) {
  if (Kotlin.isType($receiver, DefaultWebSocketSession)) 
    return $receiver;
  var $receiver_0 = DefaultWebSocketSession_0($receiver, this.pingInterval, this.pingInterval.multiply(Kotlin.Long.fromInt(2)));
  $receiver_0.maxFrameSize = this.maxFrameSize;
  return $receiver_0;
};
  WebSockets.$metadata$ = {
  kind: Kind_CLASS, 
