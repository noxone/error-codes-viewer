(function(root, factory) {
  ...
  var parseWebSocketExtensions = $module$ktor_ktor_http_cio_jsLegacy.io.ktor.http.cio.websocket.parseWebSocketExtensions_61zpoe$;
  ...
  var WebSocketExtensionsConfig = $module$ktor_ktor_http_cio_jsLegacy.io.ktor.http.cio.websocket.WebSocketExtensionsConfig;
  ...
  var escapeIfNeeded = $module$ktor_ktor_http_jsLegacy.io.ktor.http.escapeIfNeeded_pdl1vz$;
  var ByteReadPacket_0 = $module$ktor_ktor_io_jsLegacy.io.ktor.utils.io.core.ByteReadPacket_1qge3v$;
  var copyToArray = Kotlin.kotlin.collections.copyToArray;
  var Cookie = $module$ktor_ktor_http_jsLegacy.io.ktor.http.Cookie;
  var renderCookieHeader = $module$ktor_ktor_http_jsLegacy.io.ktor.http.renderCookieHeader_s2xy1c$;
  ...
  var Frame$Frame$Binary_init = $module$ktor_ktor_http_cio_jsLegacy.io.ktor.http.cio.websocket.Frame.Binary_init_3eyok5$;
  ...
  function ServerResponseException(response, cachedResponseText) {
    ...
    this.message_3dyog2$_0 = 'Server error(' + response.call.request.url + ': ' + response.status + '. Text: ' + '"' + cachedResponseText + '"';
  }
  ...
  do try {
    switch (this.state_0) {
      case 0:
        var tmp$;
        var expectSuccess = (tmp$ = this.local$call.attributes.getOrNull_yzaw86$(ExpectSuccessAttributeKey)) != null ? tmp$ : this.local$closure$feature.expectSuccess_0;
        if (expectSuccess) {
          this.state_0 = 2;
