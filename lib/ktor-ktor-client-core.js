(function(root, factory) {
  if (typeof define === 'function' && define.amd) 
    define(['exports', 'kotlin', 'kotlinx-coroutines-core', 'ktor-ktor-utils', 'ktor-ktor-io', 'ktor-ktor-http', 'ktor-ktor-http-cio'], factory);
  else if (typeof exports === 'object') 
    factory(module.exports, require('kotlin'), require('kotlinx-coroutines-core'), require('ktor-ktor-utils'), require('ktor-ktor-io'), require('ktor-ktor-http'), require('ktor-ktor-http-cio'));
  else {
    ...
    root['ktor-ktor-client-core'] = factory(typeof this['ktor-ktor-client-core'] === 'undefined' ? {} : this['ktor-ktor-client-core'], kotlin, this['kotlinx-coroutines-core'], this['ktor-ktor-utils'], this['ktor-ktor-io'], this['ktor-ktor-http'], this['ktor-ktor-http-cio']);
  }
}(this, function(_, Kotlin, $module$kotlinx_coroutines_core, $module$ktor_ktor_utils, $module$ktor_ktor_io, $module$ktor_ktor_http, $module$ktor_ktor_http_cio) {
  'use strict';
  ...
  var IOException = $module$ktor_ktor_io.io.ktor.utils.io.errors.IOException;
  ...
  ConnectTimeoutException_0.prototype = Object.create(IOException.prototype);
  ConnectTimeoutException_0.prototype.constructor = ConnectTimeoutException_0;
  ...
  function HttpClient(engineFactory, block) {
    ...
    var client = new HttpClient_1(engine, config);
  ...
  function HttpClient_1(engine, userConfig) {
    ...
    this.closed_0 = false;
    this.coroutineContext_94yqr5$_0 = this.engine.coroutineContext.plus_1fupul$(Job_0(this.engine.coroutineContext.get_j3r2sn$(Job.Key)));
  ...
  if (!success) 
    return;
  var tmp$_0;
  tmp$_0 = this.attributes.allKeys.iterator();
  while (tmp$_0.hasNext()) {
    var element = tmp$_0.next();
    var tmp$_1;
    var feature = this.attributes.get_yzaw86$(Kotlin.isType(tmp$_1 = element, AttributeKey) ? tmp$_1 : throwCCE());
  ...
  function defaultTransformers$lambda$ObjectLiteral_0(closure$body) {
    this.closure$body = closure$body;
        ...
        if (typeof this.local$body === 'string') {
          ...
          if (Kotlin.isByteArray(this.local$body)) {
            ...
            if (Kotlin.isType(this.local$body, ByteReadChannel)) {
              this.state_0 = 2;
              this.result_0 = this.local$$receiver.proceedWith_trkh7z$(new defaultTransformers$lambda$ObjectLiteral_0(this.local$body), this);
              if (this.result_0 === COROUTINE_SUSPENDED) 
                return COROUTINE_SUSPENDED;
              continue;
            } else {
  ...
  function HttpPlainText(charsets_0, charsetQuality, sendCharset, responseCharsetFallback) {
    ...
    while (tmp$_3.hasNext()) {
      ...
      $receiver.append_61zpoe$(get_name(element_0));
    }
    var tmp$_4;
    ...
    while (tmp$_4.hasNext()) {
      ...
      $receiver.append_61zpoe$(get_name(charset) + ';q=' + truncatedQuality);
    }
    if ($receiver.length === 0) {
      $receiver.append_61zpoe$(get_name(this.responseCharsetFallback_0));
    }
  ...
  function Coroutine$HttpRequestLifecycle$Feature$install$lambda($receiver_0, it_0, controller, continuation_0) {
    CoroutineImpl.call(this, continuation_0);
    this.$controller = controller;
    this.exceptionState_0 = 6;
  ...
  do try {
    switch (this.state_0) {
      case 0:
        ...
        attachToClientEngineJob(this.local$$receiver, this.local$executionContext);
        this.exceptionState_0 = 3;
  ...
  function HttpRequestLifecycle$Feature$install$lambda($receiver_0, it_0, continuation_0, suspended) {
    var instance = new Coroutine$HttpRequestLifecycle$Feature$install$lambda($receiver_0, it_0, this, continuation_0);
    if (suspended) 
      return instance;
    else 
      return instance.doResume(null);
  ...
  scope.requestPipeline.intercept_h71y74$(HttpRequestPipeline$Phases_getInstance().Before, HttpRequestLifecycle$Feature$install$lambda);
};
  ...
  interfaces: []};
  function attachToClientEngineJob$lambda(this$attachToClientEngineJob) {
    return function(cause) {
  var tmp$;
  if (cause != null) {
    cancel_2(this$attachToClientEngineJob.context.executionContext, 'Engine failed', cause);
  } else {
    (Kotlin.isType(tmp$ = this$attachToClientEngineJob.context.executionContext.get_j3r2sn$(Job.Key), CompletableJob) ? tmp$ : throwCCE()).complete();
  }
  return Unit;
};
  }
  ...
  function attachToClientEngineJob($receiver, clientEngineJob) {
    var handler = clientEngineJob.invokeOnCompletion_f05bi3$(attachToClientEngineJob$lambda($receiver));
    ensureNotNull($receiver.context.executionContext.get_j3r2sn$(Job.Key)).invokeOnCompletion_f05bi3$(attachToClientEngineJob$lambda_0(handler));
  }
  function Sender() {
  }
  Sender.$metadata$ = {
    ...
    switch (this.state_0) {
      case 0:
        if (!Kotlin.isType(this.local$content, OutgoingContent)) {
          var message = 'Fail to send body. Content has type: ' + Kotlin.getKClassFromExpression(this.local$content) + ', but OutgoingContent expected.';
          throw IllegalStateException_init(message.toString());
        }
  ...
  function ConnectTimeoutException(request, cause) {
    if (cause === void 0) 
      cause = null;
    var tmp$, tmp$_0;
    return new ConnectTimeoutException_0('Connect timeout has been expired [url=' + request.url + ', connect_timeout=' + ((tmp$_0 = (tmp$ = request.getCapabilityOrNull_1sr7de$(HttpTimeout$Feature_getInstance())) != null ? tmp$.connectTimeoutMillis : null) != null ? tmp$_0 : 'unknown').toString() + ' ms]', cause);
  }
  ...
  function renderClientCookies(cookies) {
    ...
    while (tmp$.hasNext()) {
      var element = tmp$.next();
      $receiver.append_61zpoe$(element.name);
      $receiver.append_s8itvh$(61);
      $receiver.append_61zpoe$(encodeCookieValue(element.value, CookieEncoding.DQUOTES));
  ...
  function WebSocketContent() {
    ...
    $receiver.append_61zpoe$(encodeBase64(nonce));
  ...
  function HttpRequestBuilder() {
    ...
    this.executionContext_h6ms6p$_0 = Job_0();
    this.attributes = Attributes(true);
  }
  ...
  function generateBoundary() {
    ...
    for (var index = 0; index < 32; index++) {
      $receiver.append_61zpoe$(toString_0(Random.Default.nextInt(), 16));
    }
  ...
  function ConnectTimeoutException_0(message, cause) {
    if (cause === void 0) 
      cause = null;
    IOException.call(this, message, cause);
    this.name = 'ConnectTimeoutException';
  }
  ConnectTimeoutException_0.$metadata$ = {
  kind: Kind_CLASS, 
  ...
  package$sockets.ConnectTimeoutException = ConnectTimeoutException_0;
